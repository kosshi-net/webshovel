...
class Blockhelper{
	...
	parseGeometry( id, face ){
		...
		switch(geom.type){
			...
			case "blockuv/simple":
				tex = [
					[ geom.texture.x * tr , geom.texture.x * tr + tr ], 
					[ geom.texture.y * tr , geom.texture.y * tr + tr ]
				];
				return [
					tex[0][0], tex[1][1],
					tex[0][0], tex[1][0],
			...
			case "blockuv/advanced":
				tex = [
					[ geom.texture[face].x * tr , geom.texture[face].x * tr + tr ], 
					[ geom.texture[face].y * tr , geom.texture[face].y * tr + tr ]
				];
